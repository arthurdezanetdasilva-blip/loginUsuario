    ...
    private void consultar() {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                txtCidadeCliente.setText(rs.getString("cidadeCliente"));
                txtUfCliente.setText(rs.getString("ufCliente"));
                txtCpfCliente.setText(rs.getString("cpfCliente"));
                txtTeleCliente.setText(rs.getString("telefoneCliente"));
